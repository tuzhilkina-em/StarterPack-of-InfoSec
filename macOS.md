1. Как устроена архитектура macOS: что такое XNU, Darwin, Mach, BSD layer и I/O Kit, и как это влияет на модель безопасности системы?
2. Чем macOS похожа на Linux/Unix и чем отличается от него с точки зрения процессов, файловой системы, прав доступа, сервисов и встроенных механизмов защиты?
3. Как в macOS устроены процессы, потоки и системные вызовы, и какие артефакты на уровне ОС могут быть полезны при расследовании вредоносной активности?
