...
14. ﻿Процесс построения топологии репликации КСС
15. Механизм PKInit
...
18. ﻿При сбросе УЗ компьютера какой пароль устанавливается по умолчанию и в каких функциональных уровнях лесов?
19. ﻿﻿Как работает LDAPS
20. Архитектурные типы лесов Active Directory
